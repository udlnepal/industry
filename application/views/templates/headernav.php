                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url();?>" target="_blank">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                           <!--  <img src="<?php echo base_url();?>site_assets/img/logo.png" alt="homepage" class="light-logo" /> -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                      ...
                      <!--   <li class="nav-item dropdown">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url();?>site_assets/img/user.png" alt="user" class="rounded-circle" width="31"></a>
